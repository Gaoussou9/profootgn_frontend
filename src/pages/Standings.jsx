...
export default function Standings() {
  ...
  /* ===============================
     Charger les logos (1 seule fois)
  =============================== */
  useEffect(() => {
    (async () => {
      try {
  ...
  /* ===============================
     Fetch Standings UNIQUEMENT
  =============================== */
  const fetchStandings = async () => {
    try {
      const stRes = await api.get(
        "stats/standings/?include_live=1"
      );
